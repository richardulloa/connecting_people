  ...
  return (
    ...
    <div className="Nologin">
      <div className="cabecera">
        <div>
          <img className="imglogo" src="https://th.bing.com/th/id/OIP.BSdNpNqWXmy1WQ0o0qtRCwHaFy?rs=1&pid=ImgDetMain" />
        </div>
          ...
          <div className="objetivos">
            <article>
              <p>
                ...
                sit perferendis facilis, perspiciatis necessitatibus debitis alias
                modi distinctio voluptates sequi at illum? Aliquid.
              </p>
            </article>
            <article>
              <p>
